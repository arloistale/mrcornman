"""
Django settings for mrcornman project.
...
WSGI_APPLICATION = 'mrcornman.wsgi.application'
...
STATICFILES_STORAGE = 'blog.storage.BlogCompressedManifestStaticFilesStorage'
